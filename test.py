...
if __name__ == "__main__":
    ...
    tset_in = [("xaxxxxbc", "44445555")]
    # Input ("xaxxxxbc", "44445555")
    # Arg: "4445"
    # Output: "xaxxxxbc, 44445555"
    t.test("Test standardniho reseni #3", ["4445"], tset_in, [1])
    ...
    if bonus_level == 2:
        t.test("Test na druhe rozsireni #1", ["-l", "1", "62"], SECOND_BONUS_INPUT, [1])
        t.test(
            "Test na druhe rozsireni #2", ["-l", "1", "602"], SECOND_BONUS_INPUT, [1]
        )
        t.test(
            "Test na druhe rozsireni #3", ["-l", "1", "6620"], SECOND_BONUS_INPUT, [1]
        )
        t.test(
            "Test na druhe rozsireni #4", ["-l", "1", "6020"], SECOND_BONUS_INPUT, []
        )
        t.test(
            "Test na druhe rozsireni #5", [ "-l", "2", "6020"], SECOND_BONUS_INPUT, [1]
        )
        t.test(
            "Test na druhe rozsireni #6", ["-l", "1", "626"], SECOND_BONUS_INPUT, [1]
        )
        t.test(
            "Test na druhe rozsireni #7", ["-l", "1", "626"], SECOND_BONUS_INPUT, [1]
        )
        t.test(
            "Test na druhe rozsireni #8", ["-l", "0", "662"], SECOND_BONUS_INPUT, [1]
        )
        t.test("Test na druhe rozsireni #9", ["-l", "0", "660"], SECOND_BONUS_INPUT, [])
